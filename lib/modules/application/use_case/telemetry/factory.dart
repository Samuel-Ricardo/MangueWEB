...
import 'package:mangueweb/modules/application/use_case/telemetry/gyroscope/read_gyroscope_telemetry.dart';
...
ReadGyroscopeTelemetryByHttpUseCase
    instaceOfReadGyroscopeByHttpTelemetryUseCase() =>
        ReadGyroscopeTelemetryByHttpUseCase(instaceOfGyroscopeHttpGateway());
